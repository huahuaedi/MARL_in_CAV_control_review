...
- [2. 🗂️ Backgrounds](#2-️-backgrounds)
  - [2.1 Preliminaries of Reinforcement Learning](#21-preliminaries-of-reinforcement-learning)
      - [2.1.1 Value-based Methods](#211-value-based-methods)
      - [2.1.2 Policy-based Methods](#212-policy-based-methods)
      - [2.1.3 Actor-critic Methods](#213-actor-critic-methods)
  ...
  - [2.3 Training and Execution Strategies in MARL](#23-training-and-execution-strategies-in-marl)
      ...
      - [2.3.3 Offline reinforcement learning](#233-offline-reinforcement-learning)
  - [2.4 MARL Algorithm Variants](#24-marl-algorithm-variants)
      ...
      - [2.4.3 Hierarchical structure](#243-hierarchical-structure)
      - [2.4.4 Causal inference](#244-causal-inference)
- [3. 🤖 Towards applications in connected and autonomous vehicles](#3--towards-applications-in-connected-and-autonomous-vehicles)
  ...
  - [3.3 Three-dimensional Cooperation](#33-three-dimensional-cooperation)
      - [3.3.1 Traffic signal control](#331-traffic-signal-control)
      - [3.3.2 On-ramps merging](#332-on-ramps-merging)
      - [3.3.3 Unsignalized intersections](#332-unsignalized-intersections)
  - [3.4 Simulation platforms](#34-simulation-platforms)
- [4. 📚 Corpora](#4--corpora)
